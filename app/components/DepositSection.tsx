...
export default function DepositSection() {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto bg-white p-4 md:p-6 font-sans min-h-[600px] flex flex-col relative" style={{ overflowAnchor: 'none' }}>
                        ...
                        <div className="w-full bg-white border-2 border-black p-6">
                          ...
                          <div>
                            ...
                            <button 
                                ...
                                className="w-full h-14 px-8 bg-black text-white font-bold transition-colors hover:bg-gray-800 disabled:opacity-30 whitespace-nowrap"
                            >
                                ロックする
                            </button>
                          </div>
